export const StaticData = {
    Meta_title:" Waitrose - Hub",
    Meta_description:"Visit Waitrose | Waitrose is your local great Hub. Find latest seasonal looks for Women, Men and kids, plus a huge range of homeware.",
